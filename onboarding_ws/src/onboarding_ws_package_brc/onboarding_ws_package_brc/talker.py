import rclpy # node class
from rclpy.node import Node

from std_msgs.msg import String
from pcl_msgs.srv import UpdateFilename

class Talker(Node): # Talker Subclass of Node class

    def __init__(self):
        super().__init__('talker') # Initializes a node called talker in Node Super
        ...
        self.i = 0
        self.declare_parameter("Name", "Kamil")
